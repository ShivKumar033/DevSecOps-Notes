...
```bash
# To configure a access_key and secrets_kye own you aws account.
...
```bash
# To create roles of aws secrets
...
```bash
# To generate the dynamic creds
vault read aws/creds/s3-role

# Remove the dynamic generated secrets key...
